...
//            systembartiteniam();
    ...
    public void toolbarStatusBar() {//
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar);//按键条
    ...
    public void navigationDrawer() {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {//方向
        ...
        recyclerViewDrawer.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                for (int i = 0; i < drawerTitles.length; i++) {//每个标题
    ...
    private void initiSlidingUpPanel() {
        ...
        imgbtn_toggle.setSelected((MusicPreferance.getRepeat(context) == 1) ? true : false);//切换
        ...
        imgbtn_suffel.setSelected(MusicPreferance.getShuffel(context) ? true : false);//改变模式
    ...
    public void setFragment(int position) {
        ...
        switch (position) {
            case 0:
                ...
                toolbar.setTitle("All Songs");//所以歌曲
                break;
            case 1:
                sharedPreferences.edit().putInt("FRAGMENT", position).apply();
                ...
                fragmentTransaction.commit();
                toolbar.setTitle("My Library");//曲库
                break;
            case 2:
                sharedPreferences.edit().putInt("FRAGMENT", position).apply();
            ...
            case 4:
                ...
                fragmentTransaction.commit();
                toolbar.setTitle("Equilizer");//均衡器
                break;
            ...
            case 5:
                ...
                fragmentTransaction.commit();
                toolbar.setTitle("Send feedback");//反馈
                break;
        }
    }
    ...
    private void setTranslucentStatus(boolean on) {//半透明状态
