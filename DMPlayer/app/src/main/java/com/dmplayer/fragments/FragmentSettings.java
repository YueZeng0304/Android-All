...
public class FragmentSettings extends Fragment implements View.OnClickListener {//设置碎片（setting页面）
    ...
    public void setThemeFragment(int theme) {//设置主题碎片
        switch (theme) {
            case 1:
                editor = sharedPreferences.edit();
