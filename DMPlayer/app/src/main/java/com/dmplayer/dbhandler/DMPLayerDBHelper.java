...
public class DMPLayerDBHelper extends SQLiteOpenHelper {//数据库操作类
    ...
    public static String sqlForCreateMostPlay() {//创建播放最多的数据库
    ...
    public static String sqlForCreateFavoritePlay() {//创建收藏的数据库
