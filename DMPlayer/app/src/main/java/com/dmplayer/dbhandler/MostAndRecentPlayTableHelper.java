...
public class MostAndRecentPlayTableHelper {//最多播放，最近播放，同收藏
    ...
    private boolean isSongExist(int id_) {//是否存在
        Cursor mCursor = null;
    ...
    public void updateStatus_(long count, int musicid) {//更新状态
        try {
    ...
    public Cursor getMostPlay() {//最多播放
        Cursor mCursor = null;
        try {//播放次数，上次播放时间
