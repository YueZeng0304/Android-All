 ...
 * RecyclerView.Adapter管理一个光标，比得上CursorAdapter，在ListView/GridView里可用
 */
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {//光标循环配适器
