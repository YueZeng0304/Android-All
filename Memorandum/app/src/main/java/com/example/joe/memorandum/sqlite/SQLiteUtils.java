package  com.example.joe.memorandum.sqlite;

import android.content.ContentValues;
import android.content.Context;
import android.database.sqlite.SQLiteDatabase;

import com.example.joe.memorandum.UserInfo;

public class SQLiteUtils {//数据库操作工具
	public static final String DATABASE_NAME = "zhaochen_memorandum_db";

	public static final String DATETIME = "datetime";
    public static final String CONTENT = "content";
	
		public static DatabaseHelper createDBHelper(Context context) {//创建数据库
			//����һ��DatabaseHelper����
			DatabaseHelper dbHelper = new DatabaseHelper(context,DATABASE_NAME);
			return dbHelper;
		}

		public void insert(DatabaseHelper dbHelper,UserInfo user) {//插入
			//����ContentValues����
		...
		public void update(DatabaseHelper dbHelper) {//更新
		...
		public void delete(DatabaseHelper dbHelper,String datetime){//删除
